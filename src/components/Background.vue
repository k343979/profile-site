...
export default {
  data() {
    return {
      ...
      internship_content: "シンガポール現地のSaaS企業に約1ヶ月勤めました。ホテルのホームページにチャットボットを導入するSaaS企業でした。そこで私は、シンガポール国内におけるホテル産業の市場調査と外国人旅行客の動向調査、そして自社サービスの宣伝方法を模索し、マーケティングについて学びました。",
    };
  },
  components: {
    Header
